# FIN-COMP-025 — Consensus Authority Separator
...
Enforce explicit distinction between consensus state and financial execution authority.

## Inputs

ConsensusState; AuthorityReference
